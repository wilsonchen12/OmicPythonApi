...
class DownloadMetaData(OmicPythonApi):
    """ A python api for ConnectServer and DownloadMetaData proc.
    ...
    """
    def __init__(self,ServerAddress='',ServerUserId='',ServerUserPsw='',Land='',OutputFolder=''):
...
Begin DownloadMetaData /Namespace=Land;
Land @Land@;
