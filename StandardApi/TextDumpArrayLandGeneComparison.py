...
class TextDumpArrayLandGeneComparison(OmicPythonApi):
    """ A python api for TextDumpArrayLandGeneComparison proc .
    ...
    def __init__(self,ServerAddress='',ServerUserId='',ServerUserPsw='',Land='',GeneSet='',ComparisonSet='',OutputFolder=''):
		...
		input:
            ...
            10. OutputFolder:
            11. Output: default "TextDumpArrayLandGeneComparison"
        ...
        self.Output='TextDumpArrayLandGeneComparison'
...
Begin TextDumpArrayLandGeneComparison  /Namespace=Land;
