...
class TextDumpArrayLandComparisonData(OmicPythonApi):
    """ A python api for TextDumpArrayLandComparisonData proc .
    ...
    def __init__(self,ServerAddress='',ServerUserId='',ServerUserPsw='',Land='',ComparisonSet='',OutputFolder=''):
		...
		input:
            ...
            9. OutputFolder:
            10. Output: default "TextDumpArrayLandGeneComparison"
        ...
        self.Output='TextDumpArrayLandComparisonData'
...
Begin TextDumpArrayLandComparisonData  /Namespace=Land;
