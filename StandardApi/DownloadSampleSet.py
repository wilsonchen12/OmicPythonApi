...
class DownloadSampleSet(OmicPythonApi):
    """ A python api for ConnectServer and DownloadSampleSet proc .
    ...
    """
    def __init__(self,ServerAddress='',ServerUserId='',ServerUserPsw='',Land='',SampleSet='',OutputFolder=''):
        """A python API that wraps ConnectServer and ListSampleSets. See Omicsoft wiki for the proc parameters.
		input:
...
Begin DownloadSampleSet /Namespace=Land;
Land @Land@;
SampleSet @SampleSet@;
