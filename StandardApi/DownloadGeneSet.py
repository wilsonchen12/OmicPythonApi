...
class DownloadGeneSet(OmicPythonApi):
    """ A python api for ConnectServer and DownloadGeneSet proc .
    ...
    """
    def __init__(self,ServerAddress='',ServerUserId='',ServerUserPsw='',Land='',GeneSet='',OutputFolder=''):
