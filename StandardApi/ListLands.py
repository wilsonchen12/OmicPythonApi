...
class ListLands(OmicPythonApi):
    """ A python api for ConnectServer and ListLands proc.
    ...
    """
    def __init__(self,ServerAddress='',ServerUserId='',ServerUserPsw='',OutputFolder=''):
        """
		input:
...
Begin ListLands /Namespace=Land;
